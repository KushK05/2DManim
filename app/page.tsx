...
const STEPS = [
  ...
  },
  {
    ...
    copy: 'Queue a generation job and watch status progress asynchronously.',
  },
  {
    title: '3. EXPORT VIDEO',
    copy: 'Render in your environment and publish through object storage.',
  },
];
...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    const scrollTarget = params.get('section') || window.location.hash.replace('#', '');
    if (!scrollTarget) {
    ...
    <div className="landing-page">
      <header className="landing-topbar">
        <div className="landing-container">
          ...
          <nav className="landing-nav">
            <Link href="/#core">Features</Link>
            <Link href="/pricing">Pricing</Link>
            <Link href="/#workflow">Showcase</Link>
            <Link href="/#workflow">Docs</Link>
          </nav>
          <Link href={user ? '/studio' : '/login'} className="landing-secondary-btn">
            Login
          </Link>
          <Link href={user ? '/studio' : '/register'} className="landing-primary-btn">
            Get Started
          </Link>
        </div>
      </header>
      ...
      <section className="landing-container landing-hero">
        ...
        <div className="landing-hero-actions">
          <Link href={user ? '/studio' : '/register'} className="landing-primary-btn">START CREATING NOW</Link>
          <Link href="/#workflow" className="landing-secondary-btn">View Showcase</Link>
        </div>
      </section>
      ...
      <section className="landing-cta">
        ...
        <div className="landing-hero-actions">
          <Link href={user ? '/studio' : '/register'} className="landing-primary-btn">CREATE YOUR FIRST ANIMATION</Link>
        </div>
      </section>
      ...
      <footer className="landing-footer">
        <div className="landing-container">
          ...
          <div className="landing-footer-nav">
            ...
            <Link href="/#workflow">SUPPORT</Link>
            <Link href="/#workflow">COMPANY</Link>
            <Link href="/#workflow">LEGAL</Link>
          </div>
        </div>
      </footer>
    </div>
